...
def test_parse_empty_legacy() -> None:
...
def test_parse_minimal_2023(minimal_2023_conf: dict[str, Any]) -> None:
...
def test_parse_typo_fails(minimal_2023_conf: dict[str, Any]) -> None:
    c = minimal_2023_conf
    c['limits'] = {'typo': 1}
    with pytest.raises(ValidationError):
...
def test_parse_single_author_2023(minimal_2023_conf: dict[str, Any]) -> None:
    c = minimal_2023_conf
...
def test_parse_single_source_2023(minimal_2023_conf: dict[str, Any]) -> None:
    c = minimal_2023_conf
    c['source'] = 'NWERC 2024'
    m = metadata.parse_metadata(FormatVersion.V_2023_07, c, {'en': 'Hello World!'})
...
def test_parse_multi_source(minimal_2023_conf: dict[str, Any]) -> None:
    c = minimal_2023_conf
    c['source'] = [
...
def test_parse_complex_type(minimal_2023_conf: dict[str, Any]) -> None:
    c = minimal_2023_conf
